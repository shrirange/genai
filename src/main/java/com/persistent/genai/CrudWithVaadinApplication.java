...
public class CrudWithVaadinApplication {
	...
	/*
	 * @Bean public CommandLineRunner loadData(ProductRepository repository) {
	 * return (args) -> { // save a couple of customers
	 * 
	 * repository.save(new Product("Jack", "Bauer")); repository.save(new
	 ...
	 * repository.findById(1L).get(); log.info("Customer found with findOne(1L):");
	 ...
	 * : repository .findByLastNameStartsWithIgnoreCase("Bauer")) {
